<template>
  <div class="container box my-4">
    ...
    <div class="input-group input-group-lg">
      ...
      <input type="text" class="form-control" v-on:focus="$event.target.select()" ref="generator" v-model="password"
        id="generator">
    </div>
    <div class="container my-4 text-center">
      <!-- password Character -->
      <div class="form-check form-check-inline">
        <input class="form-check-input" type="checkbox" name="char_types_alpha_numeric" v-model="config.alphaNumeric"
          id="alpha_numeric">
        <label class="form-check-label" for="alpha_numeric">Alpha Numeric</label>
      </div>
      <div class="form-check form-check-inline">
        <input class="form-check-input" type="checkbox" name="char_types_special_chars" v-model="config.specialChars"
          id="special_chars">
        <label class="form-check-label" for="special_chars">Special Chars</label>
      </div>
      <!-- password case -->
      <div class="form-check form-check-inline">
        <input class="form-check-input" name="case" type="radio" id="uppercase" v-model="config.passwordCase"
          value="uppercase">
        <label class="form-check-label" for="uppercase">Upper Case</label>
      </div>
      <div class="form-check form-check-inline">
        <input class="form-check-input" name="case" type="radio" id="lowercase" v-model="config.passwordCase"
          value="lowercase">
        <label class="form-check-label" for="lowercase">Lower Case</label>
      </div>
      <div class="form-check form-check-inline">
        <input class="form-check-input" name="case" type="radio" id="mixedcase" v-model="config.passwordCase"
          value="mixedcase">
